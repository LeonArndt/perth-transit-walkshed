...
Transit accessibility analysis for Perth, Australia that creates walksheds around transit stops and provides a framework for walkability scoring (a proof of concept).
